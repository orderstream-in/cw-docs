...
Choose "Page Tab". You will now need to fill in your store URL under "Secure Page Tab URL" and what you want to call your page tab under "Page Tab Name". Your store URL can either be your OrderStream subdomain such as "[https://yourdomain.orderstream.com](https://yourdomain.cloudwaitress.com)" or your custom domain name if setup
